...
import { faSearch, faNewspaper, faDiagramProject, faInfoCircle, faExclamationTriangle } from "@fortawesome/free-solid-svg-icons";
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {(activeTab === 'all' || activeTab === 'posts') && results.posts.length > 0 && (
              <>
                {activeTab === 'all' && (
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-2 mb-3">
                    Posts ({results.posts.length})
                  </h2>
                )}
            ...
            {(activeTab === 'all' || activeTab === 'projects') && results.projects.length > 0 && (
              <>
                {activeTab === 'all' && (
                  <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-6 mb-3">
                    Projects ({results.projects.length})
                  </h2>
                )}
                <div className="space-y-3">
