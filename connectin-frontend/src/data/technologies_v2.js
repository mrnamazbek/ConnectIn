// ../data/technologies.js - Modified Version

// Placeholder logo for Yup - replace if you find an official one
const yupLogoPlaceholder = 'https://via.placeholder.com/128x128.png?text=Yup';
// Placeholder for Uvicorn/Gunicorn - choose one or use a generic Python webserver icon
const webserverLogoPlaceholder = 'https://cdn.worldvectorlogo.com/logos/python-5.svg'; // Using Python logo as placeholder
// Placeholder for Alembic
const alembicLogoPlaceholder = 'https://avatars.githubusercontent.com/u/5 Alembic?s=200&v=4'; // Found one on GH

const technologies_v2 = [
    // --- Frontend ---
    {
        name: "React",
    ...
    {
        name: "Docker",
        logo: "https://cdn.worldvectorlogo.com/logos/docker-icon.svg",
