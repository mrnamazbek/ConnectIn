...
const AboutUsV3 = () => {
    ...
    return (
        <div className="col-span-6 my-5 flex flex-col rounded-lg border border-gray-200 bg-white shadow-xl dark:bg-gray-800 dark:border-gray-700 md:p-10">
            {/* Hero Section */}
            <div className="mb-12 rounded-lg bg-gradient-to-r from-green-600 via-teal-500 to-blue-600 py-16 text-center text-white">
