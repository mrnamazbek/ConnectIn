...
export default function NewsPage() {
    ...
    const [showAllTags, setShowAllTags] = useState(false); // State to toggle tag visibility
    const initialTagLimit = 10; // Limit for initially visible tags
    ...
    // Determine which tags to display based on showAllTags state
            ...
            <div className="flex-grow container mx-auto">
                ...
                <div className="mb-4">
                    ...
                    {allTags.length > initialTagLimit && (
                        <button onClick={() => setShowAllTags(!showAllTags)} className="mt-2 text-green-700 hover:underline text-sm" aria-label={showAllTags ? "Show fewer tags" : "Show more tags"}>
